...
type
  TfrmCadClientes = class(TForm)
    ...
    QryCadastrodocumento: TStringField;
...
procedure TfrmCadClientes.Ac_PrimeiroExecute(Sender: TObject);
begin

   dsCadastro.DataSet.First;
end;

procedure TfrmCadClientes.ACBrCEP1BuscaEfetuada(Sender: TObject);
var
 i: integer;
begin
...
procedure TfrmCadClientes.Action4Execute(Sender: TObject);
begin

   dsCadastro.DataSet.Next;
end;

procedure TfrmCadClientes.Action5Execute(Sender: TObject);
begin

   dsCadastro.DataSet.Last;
end;

procedure TfrmCadClientes.actsairExecute(Sender: TObject);
begin
 Close;
end;

procedure TfrmCadClientes.Ac_AnteriorExecute(Sender: TObject);
begin
   dsCadastro.DataSet.Prior;
end;

procedure TfrmCadClientes.Ac_CancelarExecute(Sender: TObject);
begin
 dsCadastro.DataSet.Cancel;
end;

procedure TfrmCadClientes.Ac_EditarExecute(Sender: TObject);
begin
...
procedure TfrmCadClientes.Ac_ExcluirExecute(Sender: TObject);
var
...
procedure TfrmCadClientes.Ac_IncluirExecute(Sender: TObject);
begin
...
procedure TfrmCadClientes.Ac_SalvarExecute(Sender: TObject);
begin
    dsCadastro.DataSet.Post;
end;


procedure TfrmCadClientes.AplicaUpdate(aDataset: TDataSet);
begin
...
procedure TfrmCadClientes.edtCepKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  try
...
procedure TfrmCadClientes.edtpercentualcomissaoExit(Sender: TObject);
var
...
procedure TfrmCadClientes.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
procedure TfrmCadClientes.LoadPermissao;
begin

end;

procedure TfrmCadClientes.LoadRestricao;
begin
...
procedure TfrmCadClientes.qryCadastroAfterScroll(DataSet: TDataSet);
begin
...
procedure TfrmCadClientes.SearchBox1Change(Sender: TObject);
begin

 if not   QryCadastro.Locate('nome',SearchBox1.text,[loPartialKey, loCaseInsensitive]) then begin
     QryCadastro.Locate('celular',SearchBox1.text,[loPartialKey, loCaseInsensitive])
 end;
