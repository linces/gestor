...
begin
   ...
   label1.Caption := '';
   Label1.Caption := 'ID da instalação : '+ IntToStr(LockApplication1.IDInstalacao) + #13;
   ...
   Label1.Caption := Label1.Caption + 'Versão : ' + IntToStr(LockApplication1.Versao_Sistema )+ #13;
   ...
   if LockApplication1.Sistema_DemoU then
         Label1.Caption := Label1.Caption + 'Tipo de licença: Licença Demonstração'
   else
         Label1.Caption := Label1.Caption + 'Tipo de licença: Licença Registrada'
end;
...
begin
   ...
   dados.Lines.Add( 'Endereço: '+LockApplication1.Cliente_Endereco );
