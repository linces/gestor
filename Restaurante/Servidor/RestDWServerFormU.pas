...
Begin
  If Not RESTServicePooler1.Active Then
   Begin
 //   RESTServicePooler1.AuthenticationOptions.AuthorizationOption := cbauthentication.Checked;
   // RESTServicePooler1.AuthenticationOptions.OptionParams[ES_PASSWORD] := EdUserNameDW.Text;
