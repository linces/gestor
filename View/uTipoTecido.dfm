object frmTipoTecido: TfrmTipoTecido
  Left = 0
  Top = 0
  ActiveControl = DBGrid1
  BorderStyle = bsDialog
  Caption = 'Cadastro de Tipo de Tecido'
  ClientHeight = 398
  ClientWidth = 599
  Color = clBtnFace
  ...
  object dsTipoTecido: TDataSource
    DataSet = Dados.qryTipoTecido
    Left = 80
    Top = 224
  end
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43595.658369259260000000
  ...
  object frxDBTecido: TfrxDBDataset
    UserName = 'frxDBTecido'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CODIGO=CODIGO'
      'DESCRICAO=DESCRICAO')
