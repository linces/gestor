object frmFichaPedido: TfrmFichaPedido
  Left = 0
  Top = 0
  ActiveControl = edtParcela
  BorderStyle = bsSingle
  Caption = 'Ficha de Cliente | Parcelas'
  ClientHeight = 339
  ClientWidth = 557
  Color = clBtnFace
  ...
  object qryFicha: TFDQuery
    ...
    object qryFichaTENTRADA: TAggregateField
      DefaultExpression = '0'
      FieldName = 'TENTRADA'
      Visible = True
      Active = True
    ...
    object qryFichaTSAIDA: TAggregateField
      DefaultExpression = '0'
      FieldName = 'TSAIDA'
      Visible = True
      Active = True
