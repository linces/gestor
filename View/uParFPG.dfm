object frmParFPG: TfrmParFPG
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43588.738231018520000000
    ...
    object Compra: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo10: TfrxMemoView
          AllowVectorExport = True
          Left = 1.920000000000000000
          Top = 1.880000000000000000
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'RELAT'#211'RIO DE VENDAS POR FORMA DE PAGAMENTO - DETALHADO')
          ParentFont = False
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        object frxDBFPGDDESCRICAO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'FORMA DE PAGAMENTO>>>[frxDBFPGD."DESCRICAO"]')
          ParentFont = False
        end
      end
      object GroupFooter1: TfrxGroupFooter
        ...
        object SysMemo4: TfrxSysMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[SUM(<frxDBFPGD."VALOR">,MasterData1)]')
          ParentFont = False
        end
      end
  ...
  object qryDiario: TFDQuery
    ...
    Connection = Dados.Conexao
    SQL.Strings = (
      'select fpg.descricao, sum(vf.valor)valor from vendas_fpg vf'
  ...
  object qryDiarioD: TFDQuery
    ...
    SQL.Strings = (
        ...
        's caixa, usu.login, vf.valor as valor from vendas_fpg vf'
      ' left join forma_pagamento fpg on fpg.codigo=vf.id_forma'
      ' left join vendas_master vm on vm.codigo=vf.vendas_master'
      ...
      ' where'
        ...
        'nd vf.tipo<>'#39'T'#39' and valor>0'
      ' /*where*/'
