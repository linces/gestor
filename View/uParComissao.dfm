object frmParComissao: TfrmParComissao
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43402.962338182900000000
  ...
  object qryDetalhado: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select ve.nome, vm.codigo as numero, vm.data_emissao, pro.codigo' +
        ', pro.descricao, vd.qtd,vd.preco, (vd.valor_item-vd.vdesconto) T' +
        'OTAL, coalesce(ve.cma,0)perc_comissao,  ((vd.valor_item-vd.vdesc' +
        'onto)* coalesce(ve.cma/100,0)) valor_comissao from vendas_detalh' +
        'e vd'
      'left join vendas_master vm on vm.codigo=vd.fkvenda'
      'left join vendedores ve on ve.codigo=vm.fk_vendedor'
      'left join produto pro on pro.codigo=vd.id_produto'
