...
var
    bmp : TBitmap;
begin
 //   ShowMessage('Vou adicionar categoria');
    with lv_categoria.Items.Add do
    begin
        Tag := id_categoria;
        TListItemText(Objects.FindDrawable('TxtDescricao')).Text := descricao;
        ShowMessage('Cod: '+inttostr(dm.tblgrupos.FieldByName('codigo').AsInteger)+' Descricão: '+dm.tblgrupos.FieldByName('DESCRICAO').AsString+' Ativo: '+dm.tblgrupos.FieldByName('ATIVO').AsString);
        // Icone...
    {    if icone <> '' then
        begin
...
begin
    ...
    while not dm.tblgrupos.Eof do
    begin
        AddCategoriaLv(dm.tblgrupos.FieldByName('codigo').AsInteger,
                dm.tblgrupos.FieldByName('DESCRICAO').AsString,
                dm.tblgrupos.FieldByName('ATIVO').AsString);
                dm.tblgrupos.Next;
    end;
